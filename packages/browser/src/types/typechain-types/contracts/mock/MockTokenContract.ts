...
export interface MockTokenContractInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "forwardval", data: BytesLike): Result;
...
export interface MockTokenContract extends BaseContract {
  ...
  forwardval: TypedContractMethod<
  ...
  mint: TypedContractMethod<[recipient: AddressLike], [void], "payable">;
