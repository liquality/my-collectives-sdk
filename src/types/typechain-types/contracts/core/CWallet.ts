...
export interface CWalletInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "refundBalance",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface CWallet extends BaseContract {
  connect(runner?: ContractRunner | null): CWallet;
  waitForDeployment(): Promise<this>;

  interface: CWalletInterface;
  ...
  refundBalance: TypedContractMethod<
