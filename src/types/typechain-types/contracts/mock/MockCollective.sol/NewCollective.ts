...
export interface NewCollectiveInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface NewCollective extends BaseContract {
  connect(runner?: ContractRunner | null): NewCollective;
  waitForDeployment(): Promise<this>;

  interface: NewCollectiveInterface;
